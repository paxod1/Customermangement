...
function DailyCustomerUpdate() {
  ...
  const [way, setWay] = useState("helooo");
  ...
  useEffect(() => {
    async function fetchCustomer() {
      try {
        ...
        console.log("response",response.data.way);
                ...
                <div className="customer_details">
                  <div className="left_column">
                    ...
                    <label>
                      ...
                      <input type="text" value="MERN Stack" className="updatecustomerpage_input" disabled />
                    </label>
                    <label>
                    ...
                    <label>
                    <span className="customer_label" style={{ color: 'black' }}>
                      Write The Daily Updates:
                    </span>
                    <textarea
                      value={dailyUpdate}
